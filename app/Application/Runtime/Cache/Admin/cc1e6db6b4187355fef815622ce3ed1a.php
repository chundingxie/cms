...
<html>
    ...
    <script src="/cms/Public/extend/jquery-ui-bootstrap/assets/js/jquery-1.9.0.min.js" type="text/javascript"></script>
    <script src="/cms/Public/js/admin/login.js" type="text/javascript"></script>
    <style type="text/css">
         body {
         ...
         <div class="footer">
            <div class="inner">
                <div class="copyright clearfix">
                    <p class="copyright_ch"><a target="_blank" href="<?php echo C('SITE_URL');?>">cms内容管理系统</a></p>
