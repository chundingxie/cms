...
CREATE TABLE `chou_channel` (
  ...
  `ispart` tinyint(2) DEFAULT '0' COMMENT '频道属性(0:最终列表栏目 1：菜单 2：外部链接 3:频道封面)',
...
-- ----------------------------
INSERT INTO `chou_config` VALUES ('1', '0', 'sitename', '内容管理系统', '网站标题', '1');
INSERT INTO `chou_config` VALUES ('11', '1', 'fadein_top', '内容管理系统', '网站头文字（上）', '1');
INSERT INTO `chou_config` VALUES ('12', '2', 'fadein_bottom', '内容管理系统', '网站头文字（下）', '1');
INSERT INTO `chou_config` VALUES ('2', '3', 'siteurl', '/', '网站域名', '1');
INSERT INTO `chou_config` VALUES ('3', '4', 'siteinfo', '后台管理系统,是一款完全开源免费的PHP+MYSQL系统.核心采用了Thinkphp框架等众多开源软件,同时核心功能也作为开源软件发布', '网站描述', '1');
INSERT INTO `chou_config` VALUES ('4', '5', 'sitekeywords', 'cms网站内容管理系统,PHP,thinkphp', '关键词', '1');
INSERT INTO `chou_config` VALUES ('5', '6', 'siteemail', '1114526565@qq.com', '邮箱', '1');
INSERT INTO `chou_config` VALUES ('7', '0', 'thumb_width', '360', '缩略图宽度', '2');
INSERT INTO `chou_config` VALUES ('8', '0', 'thumb_height', '360', '缩略图高度', '2');
INSERT INTO `chou_config` VALUES ('9', '0', 'imgtype', 'jpg|png|gif|jpeg', '图片上传类型', '2');
INSERT INTO `chou_config` VALUES ('10', '0', 'softtype', 'zip|gz|rar|iso|doc|xsl|ppt|wps', '软件上传类型', '2');
...
INSERT INTO `chou_menu` VALUES ('21', '20', '系统首页', '', '1', '2', '0', '3', 'Index', 'main', 'Admin');
