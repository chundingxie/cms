...
//数据库表达式
    ...
    protected $tags = array(
        ...
        //频道标签
        'channel' => array('attr' => "type,limit,typeid", 'close' => 1)
    );
    ...
    /**
     * 频道标签
     * 例: <channel typeid="2" limit="10" type='top'></article>
     * 参数使用说明:
    ...
    public function _channel($attr, $content) {
        ...
        $where = array();
        $where['ispart'] = 3;
        $list = M("channel")->field($field)->where($where)->limit($limit)->order($order)->select();
